...
function CategoryList(props) {
    ...
    const onFilterChange = React.useCallback((filterModel) => {
        // navigate(`/dashboard/category?page=${event.page}&limit=${event.pageSize}`)
    ...
    const handleEditUser = (itemSelected) => {
        ...
        navigate(`/dashboard/category/${itemSelected.id}`)
    }
    ...
    return (
      ...
      <DataGrid
          ...
          rows={props.listCategories || []}
          //    autoPageSize={true}
          //    rowCount={props.totalCategories}
          ...
          //    rowBuffer={props.totalCategories}
          rowCount={props.totalCategories}
            filterMode="server"
...
const mapState = (state) => ({
    ...
    totalCategories: state.category.totalCategories,
});
