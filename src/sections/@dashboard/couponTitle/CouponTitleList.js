...
function CouponTitleList(props) {
    ...
    const onFilterChange = React.useCallback((filterModel) => {
        // navigate(`/dashboard/coupon-title?page=${event.page}&limit=${event.pageSize}`)
    ...
    const handleEditCouponTitle = (itemSelected) => {
        setItemSelected(itemSelected)
        navigate(`/dashboard/coupon-title/${itemSelected.id}`)
    }
    const getListCouponTitle = async() => {
      setLoading(true)
      let query = {
        ...
        props.getListCouponTitle(query);
        setLoading(false)
    }
    useEffect(() => {
    ...
    return (
      ...
      <DataGrid
          ...
          //    autoPageSize={true}
          //    rowCount={props.totalCouponTitle}
          ...
          //    rowBuffer={props.totalCouponTitle}
          rowCount={props.totalCouponTitle}
            filterMode="server"
...
const mapState = (state) => ({
    ...
    totalCouponTitle: state.couponTitle.totalCouponTitle,
});
const mapDispatch = (dispatch) => ({
    getListCouponTitle: dispatch.couponTitle.getList
});
export default connect(mapState, mapDispatch)(CouponTitleList)
